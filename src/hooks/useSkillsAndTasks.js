import { deleteSkillById, addNewSkill, getAllSkills, getSkillById } from "../services/skillServices";
import { getTaskBySkill, deleteTaskById } from "../services/taskServices";
...
export function useSkillsAndTasks() {
    ...
    return {skills, tasks, setSelectedSkill, removeSkill, addSkill, removeTask}
}